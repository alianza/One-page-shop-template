	...
	<body>
        ...
        <div id="top_div">
            ...
            <div id="item_desc">
                ...
                <button class="order_button">Order now</button><button class="order_button">Read more</button>
        ...
        <div id="products_div_container">
            ...
            <div id="products_div">
                <div id="product_box1"  class="products_box">
                    ...
                    <button class="item_order_button">1m $9,99</button>
                </div>
                ...
                <div id="products_box3" class="products_box">
                    ...
                    <button class="item_order_button">5m $39,99</button>
                </div>
            ...
            <div class="dropdown">
                    <button class="dropbtn">Choose length</button>
